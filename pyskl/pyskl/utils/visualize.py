    ...
    def __init__(self, item, layout='nturgb+d', fps=12, angle=(30, 45), fig_size=(8, 8), dpi=80):
        ...
        if self.layout == 'nturgb+d':
            ...
            self.links = np.array([
                ...
                (19, 18), (20, 19), (22, 8), (23, 8), (24, 12), (25, 12)], dtype=int) - 1
            self.left = np.array([5, 6, 7, 8, 13, 14, 15, 16, 22, 23], dtype=int) - 1
            self.right = np.array([9, 10, 11, 12, 17, 18, 19, 20, 24, 25], dtype=int) - 1
